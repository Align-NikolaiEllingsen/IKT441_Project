...
class GameState:
    def __init__(self, display_hidden=False):
        ...
        self.static = [
            ...
            # Outer boundary
            pymunk.Segment(self.space.static_body,(o1.position), (o2.position), 2),
            pymunk.Segment(self.space.static_body,(o2.position), (o3.position), 2),
            pymunk.Segment(self.space.static_body,(o3.position), (o4.position), 2),
            pymunk.Segment(self.space.static_body,(o4.position), (o5.position), 2),
            pymunk.Segment(self.space.static_body,(o5.position), (o6.position), 2),
            pymunk.Segment(self.space.static_body,(o6.position), (o7.position), 2),
            pymunk.Segment(self.space.static_body,(o7.position), (o8.position), 2),
            pymunk.Segment(self.space.static_body,(o8.position), (o9.position), 2),
            pymunk.Segment(self.space.static_body,(o9.position), (o10.position), 2),
            pymunk.Segment(self.space.static_body,(o10.position), (o11.position), 2),
            pymunk.Segment(self.space.static_body,(o11.position), (o12.position), 2),
            pymunk.Segment(self.space.static_body,(o12.position), (o13.position), 2),
            pymunk.Segment(self.space.static_body,(o13.position), (o14.position), 2),
            pymunk.Segment(self.space.static_body,(o14.position), (o15.position), 2),
            pymunk.Segment(self.space.static_body,(o15.position), (o16.position), 2),
            pymunk.Segment(self.space.static_body,(o16.position), (o17.position), 2),
            pymunk.Segment(self.space.static_body,(o17.position), (o18.position), 2),
            pymunk.Segment(self.space.static_body,(o18.position), (o19.position), 2),
            pymunk.Segment(self.space.static_body,(o19.position), (o20.position), 2),
            pymunk.Segment(self.space.static_body,(o20.position), (o1.position), 2),

            # Inner boundary
            pymunk.Segment(self.space.static_body,(i1.position), (i2.position), 2),
            pymunk.Segment(self.space.static_body,(i2.position), (i3.position), 2),
            pymunk.Segment(self.space.static_body,(i3.position), (i4.position), 2),
            pymunk.Segment(self.space.static_body,(i4.position), (i5.position), 2),
            pymunk.Segment(self.space.static_body,(i5.position), (i6.position), 2),
            pymunk.Segment(self.space.static_body,(i6.position), (i7.position), 2),
            pymunk.Segment(self.space.static_body,(i7.position), (i8.position), 2),
            pymunk.Segment(self.space.static_body,(i8.position), (i9.position), 2),
            pymunk.Segment(self.space.static_body,(i9.position), (i10.position), 2),
            pymunk.Segment(self.space.static_body,(i10.position), (i11.position), 2),
            pymunk.Segment(self.space.static_body,(i11.position), (i12.position), 2),
            pymunk.Segment(self.space.static_body,(i12.position), (i13.position), 2),

            pymunk.Segment(self.space.static_body,(i1.position), (i8.position), 2),
        ]
